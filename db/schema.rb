...
ActiveRecord::Schema.define(version: 20150515131629) do
  ...
  add_index "contacts_groups", ["contact_id", "group_id"], name: "index_contacts_groups_on_contact_id_and_group_id", unique: true, using: :btree
